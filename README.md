# Billionaire Demographic and Distribution Analysis 
...
-	What industries dominate global wealth?
...
2.	Billionaires by Industry
  -	Created a Pivot table for industry vs. billionaire count
  -	Chart: Bar chart showing the dominant industries
3.	Gender Distribution
  -	Pivot table showing Male vs Female counts
  -	Donut chart showing the gender distribution of billionaires
4.	Self-Made vs Inherited
...
-	By examining factors such as country, industry, age, gender, and self-made status, the analysis reveals where wealth is most concentrated and which industries dominate billionaire creation.
-	The dashboard highlights key patterns including the most dominant industries, the top countries, average age trends, and the proportion of self-made billionaires
